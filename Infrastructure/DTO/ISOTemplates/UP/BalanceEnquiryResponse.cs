...
public class BalanceEnquiryResponse : BaseMessage {
    [IsoField(position: IsoFields.Field002, maxLen: 19, lengthType: LengthType.FIXED, contentType: ContentType.N)]
    ...
    [IsoField(position: IsoFields.Field054, maxLen: 255, lengthType: LengthType.LVAR, contentType: ContentType.B)]
